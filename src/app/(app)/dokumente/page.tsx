...
async function getDocuments(): Promise<UnifiedDocument[]> {
  ...
  const docs: UnifiedDocument[] = [
    ...quotes.map((q) => ({
      ...
      contactName: q.contact.companyName || [q.contact.firstName, q.contact.lastName].filter(Boolean).join(" ") || "–",
    ...
    ...deliveryNotes.map((d) => ({
      ...
      contactName: d.contact.companyName || [d.contact.firstName, d.contact.lastName].filter(Boolean).join(" ") || "–",
      linkedTo: undefined,
    ...
    ...attachments.map((a) => ({
      ...
      contactName: a.contact?.companyName || [a.contact?.firstName, a.contact?.lastName].filter(Boolean).join(" ") || undefined,
